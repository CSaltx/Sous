...
const tests = [
  ...
  [
    "optimizes if with else if",
    core.ifStatement(
      core.binary("==", 5, 2),
      [core.assignment(x, 5)],
      core.ifStatement(x, [xmm], [])
    ),
    core.ifStatement(x, [xmm], []),
  ],
  [
    "does not optimize short if without bool test",
    core.shortIfStatement(x, [xmm]),
    core.shortIfStatement(x, [xmm]),
  ],
  [
  ...
  [
    "optimizes pyth for range",
    core.pythForStatement(
      core.variable("i", false, core.intType),
      core.variable("x", false, core.intType),
      core.variable("x", false, core.intType),
      [core.assignment("x", core.binary("+", 5, 3))]
    ),
    core.pythForStatement(
      core.variable("i", false, core.intType),
      core.variable("x", false, core.intType),
  ...
  [
    "optimizes for range loop",
    core.forRangeStatement(
      core.variableDeclaration("i", false, 0),
      core.binary("<", 5, 3),
      xmm,
      []
    ),
  ...
  [
    "optimizes variable declaration",
    core.variableDeclaration("x", false, core.binary("+", 5, 8)),
    core.variableDeclaration("x", false, 13),
  ],
  [
  ...
  ["does not optimize break", core.breakStatement(), core.breakStatement()],
  [
    "does not optimize short return",
    core.breakStatement(),
    core.breakStatement(),
  ],
  [
    "does not optimize while without bool",
    core.whileStatement(x, []),
    core.whileStatement(x, []),
  ],
  [
    "does not optimize regular collection loop",
    core.forStatement(x, x, []),
    core.forStatement(x, x, []),
  ],
  [
    "optimizes regular for range loop",
    core.forRangeStatement(
      core.variableDeclaration("i", false, 0),
      core.binary(">", 5, 3),
      xmm,
    ...
    core.forRangeStatement(core.variableDeclaration("i", false, 0), true, xmm, [
      core.assignment("x", 8),
    ]),
    ,
  ],
  ...
  [
    "does not optimize unary op with non-numeric",
    core.unary("-", x),
    core.unary("-", x),
  ],
  [
    ...
    ...Array(2).fill([
      ...
      core.classDeclaration(core.classType("C", [], [])),
